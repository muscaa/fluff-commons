...
dependencies {
    ...
    api("dev.musca:fluff-files:2.0.0")
    api("dev.musca:fluff-bin:2.0.0")
    api("dev.musca:fluff-reflection:2.0.0")
    api("dev.musca:fluff-logging:2.0.0")
    api("dev.musca:fluff-sorting:2.0.0")
    api("dev.musca:fluff-crypto:2.0.0")
    api("dev.musca:fluff-json:2.0.0")
    api("dev.musca:fluff-http:2.0.0")
}
...
mavenPublishing {
    ...
    pom {
        name.set("Fluff Commons")
        description.set("A library that includes a collection of commonly used Fluff libraries, providing essential tools and utilities for various tasks")
